...
const Category = () => {
  ...
  const category: Category[] = [
    {
      img: "/img/weather.png",
      header: "Calculated Trip",
      subheader:
        "Plan your trip with precision and enjoy a seamless travel experience.",
    },
    {
      img: "/img/flight.png",
      header: "Best Flights",
      subheader:
        "Find the best flights at the best prices for your next adventure.",
    },
    {
      img: "/img/event.png",
      header: "Exciting Events",
      subheader:
        "Discover and book tickets for the most exciting events around the world.",
    },
    {
      img: "/img/settings.png",
      header: "Customization",
      subheader:
        "Personalize your travel plans to suit your preferences and needs.",
    },
  ];
  return (
    <main
