...
const Sponsors = () => {
    ...
    return ( 
        <main className="px-[5%] py-[40px] flex items-center justify-center md:justify-between basis-56 flex-wrap gap-6">
            ...
            <div className="p-2 md:p-4 rounded-xl bg-white hover:shadow-md shadow-md md:shadow-none flex items-center justify-center h-[100px]" key={index} data-aos="zoom-in">
